...
export const NewGeoLayerForm = () => {
    ...
    const createNewGeoLayer = () => {
        if (layerName) {
            axios.post(import.meta.env.VITE_API_MAP_LAYER_SAVE_MAP_LAYER, {
            ...
            dispatch(actions.setLogMessage({"message": "Invalid Layer Name", "level": "info"}));
            setTimeout(() => actions.setLogMessage({}), 5000);
        }
